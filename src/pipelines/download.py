...
async def process_download(query: str, output_dir: Path, proxy: Optional[str] = None) -> tuple[VideoInfo, Path]:
    """处理视频"""
    ...
    video_path = await downloader.download_video(video_info)
